...
class MPRAnalyzer {
    ...
    //         $daily_data[$day] = isset($result['daily_total']) ? ['daily_total'] : 0;
    //     }
    ...
    public function getDailyCollections($table_name, $account_id, $month, $year) {
        ...
        for ($day = 1; $day <= 31; $day++) {
            ...
            // ✅ FIX: Assign the actual numeric value, not an array
            $daily_data[$day] = isset($result['daily_total']) ? (float)$result['daily_total'] : 0;
        }
...
<head>
    ...
    <title><?php echo APP_NAME; ?> - Monthly Performance Report</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <h1 class="text-xl font-bold text-gray-900"><?php echo APP_NAME; ?> - MPR Dashboard</h1>
                </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <?php for ($day = 1; $day <= 31; $day++): ?>
                                <?php 
                                // $amount = isset($daily_collections[$day]) ? $daily_collections[$day] : 0;
                                // $daily_totals[$day] += $amount;
                                $amount = isset($daily_collections[$day]) ? (float)$daily_collections[$day] : 0;
                                $daily_totals[$day] = isset($daily_totals[$day]) ? $daily_totals[$day] + $amount : $amount;
