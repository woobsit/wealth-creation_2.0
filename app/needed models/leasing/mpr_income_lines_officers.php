...
foreach ($officer_comparison as $officer) {
    ...
    if ($ratio >= 1.5) $performance_score = 100;   // 150%+ of target
        elseif ($ratio >= 1.4) $performance_score = 95;
        elseif ($ratio >= 1.3) $performance_score = 90;
        elseif ($ratio >= 1.2) $performance_score = 85;
        elseif ($ratio >= 1.1) $performance_score = 80;
        elseif ($ratio >= 1.0) $performance_score = 75;
        elseif ($ratio >= 0.9) $performance_score = 70;
        elseif ($ratio >= 0.8) $performance_score = 65;
        elseif ($ratio >= 0.7) $performance_score = 60;
        elseif ($ratio >= 0.6) $performance_score = 55;
        elseif ($ratio >= 0.5) $performance_score = 50;
        elseif ($ratio >= 0.4) $performance_score = 45;
        elseif ($ratio >= 0.3) $performance_score = 40;
        elseif ($ratio >= 0.2) $performance_score = 35;
        else $performance_score = 30;
    }
        ...
        <!-- <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">  
                        <p class="text-sm font-medium text-gray-500">Total Targets of <?php echo $total_officers; ?> Officers for: <?php echo $selected_month_name . ' ' . $selected_year; ?> </p>
