...
$account = new Account();
$postprocessor = new PaymentProcessor();
...
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <p>Welcome to your dashboard! Your dashboard is peculiar to your <?php echo $staff['department']; ?> Department. Please always logout of your account for security reasons. </p>
