...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    //Array ( [title] => Payment for 32kVA Inverter [category] => Equipment [amount] => 3000000 [currency] => NGN [department] => Marketing [priority] => high [due_date] => 2025-10-17 [description] => 500KvA inverter, with Hybrid. [justification] => For the electricity backup in Business Development Unit [submit] => ) 
    $data = [
    ...
    if ($result['success']) {
        ...
        $message = isset($result['message']) ? $result['message'] : 'Failed to create requisition';
        $messageType = 'error';
    }
}
                    ...
                    <form method="POST" class="p-6 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="number" id="amount" name="amount" required step="0.01" min="0"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                       placeholder="0.00"
                                       value="<?php echo htmlspecialchars(isset($_POST['amount']) ? $_POST['amount'] : ''); ?>">
                            </div>
                            ...
                            <div>
                                ...
                                <select id="currency" name="currency"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    <option value="NGN" <?php echo (isset($_POST['currency']) ? $_POST['currency'] : 'NGN') === 'NGN' ? 'selected' : ''; ?>>NGN (₦)</option>
                            ...
                            <div>
                                ...
                                <select id="department" name="department" required
                                    ...
                                    <?php foreach ($departments as $dept): ?>
                                        <option value="<?php echo $dept; ?>" <?php echo ((isset($_POST['department']) ? $_POST['department'] : $_SESSION['department']) === $dept) ? 'selected' : ''; ?>>
                                            <?php echo $dept; ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select id="priority" name="priority"
                                    ...
                                    <option value="medium" <?php echo ((isset($_POST['priority']) ? $_POST['priority'] : 'medium') === 'medium') ? 'selected' : ''; ?>>Medium</option>
                            ...
                            <div>
                                ...
                                <input type="date" id="due_date" name="due_date"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                       value="<?php echo htmlspecialchars(isset($_POST['due_date']) ? $_POST['due_date'] : ''); ?>">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" required rows="4"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                      placeholder="Provide detailed description of the requisition"><?php echo htmlspecialchars(isset($_POST['description']) ? $_POST['description'] : ''); ?></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="justification" name="justification" required rows="3"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                      placeholder="Explain why this requisition is necessary"><?php echo htmlspecialchars(isset($_POST['justification']) ? $_POST['justification'] : ''); ?></textarea>
                        </div>
