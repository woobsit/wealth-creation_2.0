                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php echo isset($modification['receipt_no']) ? $modification['receipt_no']  : '-'; ?>
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-900">
                                <?php echo substr($modification['trans_desc'], 0, 50) . (strlen($modification['trans_desc']) > 50 ? '...' : ''); ?>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right">
                                ₦<?php echo number_format((isset($modification['debit_amount']) ? $modification['debit_amount'] : 0) + (isset($modification['credit_amount']) ? $modification['credit_amount'] : 0)); ?>
                            </td>
