...
if ($posting_officer_dept == "Wealth Creation") {
    ...
    $totalRemitted = $transactionManager->getRemittanceSummaryForToday($user_id);
}
...
<body class="bg-gray-100 font-sans">
    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        ...
        <div class="flex items-center justify-between bg-white p-4 rounded shadow mb-6">
            ...
            Remitted: <span class="text-lg text-green-600"><?= isset($totalRemitted['remitted']) ? formatCurrency($totalRemitted['remitted']) : 0 ?> </span>   |   Posted: <span class="text-lg text-red-600"><?= isset($totalRemitted['posted']) ? formatCurrency($totalRemitted['posted']) : 0 ?></span>  |  Unposted: <span class="text-lg text-red-600"><?= isset($totalRemitted['unposted']) ? formatCurrency($totalRemitted['unposted']) : 0 ?></span>
            </div>
            ...
            <section class="lg:col-span-2 bg-white rounded-xl shadow-md p-6 border border-gray-100">
                <form method="POST" action="" id="payment_form">
                    ...
                    <div id="default_info_section"
                        ...
                        <h2 class="text-3xl font-extrabold text-gray-800 mb-4"> Income Lines Posting
                            Portal 💰
                        </h2>
                        <hr class="mb-4">
                    ...
                    <div id="form_car_loading"
                        ...
                        <div class="mt-6">
                            ...
                            <input type="number" name="amount_paid" id="cl_amount" step="1" readonly
                    ...
                    <div id="form_car_sticker"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                            <div>
                                ...
                                <div>
                                    ...
                                    <select name="shop_no" data-required="true"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                        <option value="">Select...</option>
                                        <?php foreach ($kclamp as $kcustomer): ?>
                                            <option
                                                value="<?php echo "{$kcustomer['shop_no']} - {$kcustomer['customer_name']}"; ?>"
                                        ...
                                        <?php foreach ($all_customers as $customer): ?>
                                            <option
                                                value="<?php echo "{$customer['shop_no']} - {$customer['customer_name']}"; ?>"
                        ...
                        <div class="mt-6">
                            ...
                            <input type="number" value="60000" name="amount_paid" id="" step="1" readonly
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-50 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                    </div>
                    ...
                    <div id="form_toilet_collection"
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="transaction_descr" id="ld_desc" rows="2"
                                ...
                                readonly>Toilet Collection Charges</textarea>
                        </div>
                    </div>
                    ...
                    <div id="form_other_pos"
                        ...
                        <div class="mt-6">
                            ...
                            <input type="number" name="amount_paid" id="op_amount" step="1" readonly
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-50 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="transaction_descr" id="cp_desc" rows="2" readonly
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-100">Other POS Tickets</textarea>
                        </div>
                    </div>
                    ...
                    <div id="form_loading"
                        ...
                        <div>
                            ...
                            <select name="category" id="ld_category" onchange="calculateAmount()" data-required="true"
                                ...
                                <option data-amount="15000" value="Goods (Offloading) - N15000">Goods (Offloading) -
                                    N15000</option>
                                <option data-amount="20000" value="Goods (Offloading) - N20000">Goods (Offloading) -
                                    N20000</option>
                                <option data-amount="30000" value="Goods (Offloading) - N30000">Goods (Offloading) -
                                    N30000</option>
                                <option data-amount="20000" value="Goods (Loading) - N20000">Goods (Loading) - N20000
                                </option>

                                <option data-amount="2500" value="Fruits (Offloading) - N2500">Fruits (Offloading) -
                                    N2500</option>
                                <option data-amount="3500" value="Fruits (Offloading) - N3500">Fruits (Offloading) -
                                    N3500</option>
                                <option data-amount="7000" value="Fruits (Offloading) - N7000">Fruits (Offloading) -
                                    N7000</option>
                                <option data-amount="15000" value="Fruits (Offloading) - N15000">Fruits (Offloading) -
                                    N15000</option>

                                <option data-amount="3500" value="Apple Bus (Loading) - N3500">Apple Bus (Loading) -
                                    N3500</option>
                                <option data-amount="7000" value="Cargo Truck (Loading) - N7000">Cargo Truck (Loading) -
                                    N7000</option>
                                <option data-amount="15000" value="Cargo Truck 1 (Offloading) - N15000">Cargo Truck 1
                                    (Offloading) - N15000</option>
                                <option data-amount="20000" value="Cargo Truck 2 (Offloading) - N20000">Cargo Truck 2
                                    (Offloading) - N20000</option>
                                <option data-amount="20000" value="OK Truck (Offloading) - N20000">OK Truck (Offloading)
                                    - N20000</option>

                                <option data-amount="15000" value="20 feet container - (Loading) - N15000">20 feet
                                    container - (Loading) - N15000</option>
                                <option data-amount="15000" value="20 feet container - (Offloading) - N15000">20 feet
                                    container - (Offloading) - N15000</option>

                                <option data-amount="30000" value="40 feet container - (Offloading) N30000">40 feet
                                    container - (Offloading) N30000</option>
                                <option data-amount="30000"
                                    value="40 feet container - (Abassa Offloading - Weekend) - N30000">40 feet container
                                    - (Abassa Offloading - Weekend) - N30000</option>
                                <option data-amount="60000"
                                    value="40 feet container - (Shoe Offloading - Weekend) - N60000">40 feet container -
                                    (Shoe Offloading - Weekend) - N60000</option>
                                <option data-amount="30000" value="40 feet container - (Apple Offloading) - N30000">40
                                    feet container - (Apple Offloading) - N30000</option>
                                <option data-amount="60000"
                                    value="40 feet container - (Apple Offloading - Sunday) - N60000">40 feet container -
                                    (Apple Offloading - Sunday) - N60000</option>
                                <option data-amount="30000"
                                    value="40 feet container - (Ok, Curtain Offloading) - N30000">40 feet container -
                                    (Ok, Curtain Offloading) - N30000</option>

                                <option data-amount="4000" value="LT Buses (Offloading) - N4000">LT Buses (Offloading) -
                                    N4000</option>
                                <option data-amount="7000" value="LT Buses (Offloading - Sunday) - N7000">LT Buses
                                    (Offloading - Sunday) - N7000</option>
                                <option data-amount="4000" value="LT Buses (Loading) - N4000">LT Buses (Loading) - N4000
                                </option>

                                <option data-amount="3000" value="Mini LT Buses (Loading) - N3000">Mini LT Buses
                                    (Loading) - N3000</option>
                                <option data-amount="3000" value="Mini LT Buses (Offloading) - N3000">Mini LT Buses
                                    (Offloading) - N3000</option>

                                <option data-amount="1000" value="LT Buses Army Staff (Loading) - N1000">LT Buses Army
                                    Staff (Loading) - N1000</option>
                                <option data-amount="2000" value="LT Buses Army Staff (Loading) - N2000">LT Buses Army
                                    Staff (Loading) - N2000</option>

                                <option data-amount="5000" value="Mini Van (Loading) - N5000">Mini Van (Loading) - N5000
                                </option>
                                <option data-amount="5000" value="Mini Van (Offloading) - N5000">Mini Van (Offloading) -
                                    N5000</option>
                                <option data-amount="6000" value="OK Mini Van (Loading) - N6000">OK Mini Van (Loading) -
                                    N6000</option>
                                <option data-amount="6000" value="OK Mini Van (Offloading) - N6000">OK Mini Van
                                    (Offloading) - N6000</option>

                                <option data-amount="2000" value="Sienna Buses (Loading) - N2000">Sienna Buses (Loading)
                                    - N2000</option>
                                <option data-amount="30000" value="Oil Tanker (Offloading) - N30000">Oil Tanker
                                    (Offloading) - N30000</option>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-6">
                            ...
                            <input type="number" name="amount_paid" id="loading_amount" step="1" readonly
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-50 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                    ...
                    <div class="form-section hidden bg-white p-6 my-5 rounded-lg shadow-md" id="form_daily_trade">
                        ...
                        <div class="mb-4">
                            <label class="block mb-2 font-bold text-gray-800">Amount <span
                                    class="text-red-600">*</span></label>
                            <input type="number" name="amount_paid" id="dt_amount" step="1" readonly
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="transaction_descr" id="dt_desc" rows="2"
                                class="w-full px-3 py-2 border border-gray-300 rounded focus:border-blue-500 focus:outline-none text-sm bg-gray-50" readonly>Daily Trade Tickets</textarea>
                        </div>
                    </div>

                    <!-- Daily Trade Arrears Form -->
                    <div class="form-section hidden bg-white p-6 my-5 rounded-lg shadow-md"
                        id="form_daily_trade_arrears">
                        <h3 class="text-xl font-semibold text-gray-800 border-b-2 border-blue-500 pb-2 mb-5">Daily Trade
                            Arrears
                            Details</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div class="mb-4">
                                <label class="block mb-2 font-bold text-gray-800">Ticket Category <span
                                        class="text-red-600">*</span></label>
                                <select name="ticket_category" id="daily_trade_a_ticket_category"
                                    onchange="calculateAmount()"
                                    class="w-full px-3 py-2 border border-gray-300 rounded focus:border-blue-500 focus:outline-none text-sm">
                                    <option value="300">&#8358;300</option>
                                    <option value="500">&#8358;500</option>
                            ...
                            <div class="mb-4">
                                <label class="block mb-2 font-bold text-gray-800">No of Tickets <span
                                        class="text-red-600">*</span></label>
                                <input type="number" name="no_of_tickets" id="daily_trade_a_no_tickets"
                                    min="1" onchange="calculateAmount()"
                                    class="w-full px-3 py-2 border border-gray-300 rounded focus:border-blue-500 focus:outline-none text-sm">
                            </div>
                        </div>
                        <div class="mb-4">
                            <label class="block mb-2 font-bold text-gray-800">Amount <span
                                    class="text-red-600">*</span></label>
                            <input type="number" name="amount_paid" id="daily_trade_a_amount" step="1"
                                readonly class="w-full px-3 py-2 border border-gray-300 rounded bg-gray-100 text-sm">
                        </div>
                        <div class="mb-4">
                            <label class="block mb-2 font-bold text-gray-800">Transaction Description</label>
                            <textarea name="transaction_descr" id="dt_desc" rows="2"
                                class="w-full px-3 py-2 border border-gray-300 rounded focus:border-blue-500 focus:outline-none text-sm bg-gray-50" readonly>Daily Trade Arrears Permit</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-section hidden bg-white p-6 my-5 rounded-lg shadow-md" id="form_hawkers">
                        ...
                        <div class="mb-4">
                            <label class="block mb-2 font-bold text-gray-800">Amount <span
                                    class="text-red-600">*</span></label>
                            <input type="number" name="amount_paid" id="hw_amount" step="1"
                                class="bg-gray-100 w-full px-3 py-2 border border-gray-300 rounded focus:border-blue-500 focus:outline-none text-sm">
                        </div>
                        <div class="mb-4">
                            <label class="block mb-2 font-bold text-gray-800">Transaction Description</label>
                            <textarea name="transaction_descr" id="hw_desc" rows="2"
                                class="bg-gray-50 w-full px-3 py-2 border border-gray-300 rounded focus:border-blue-500 focus:outline-none text-sm" readonly>Hawker Tickets</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-section hidden bg-white p-6 my-5 rounded-lg shadow-md" id="form_wheelbarrow">
                        ...
                        <div class="mb-4">
                            <label class="block mb-2 font-bold text-gray-800">Amount <span
                                    class="text-red-600">*</span></label>
                            <input type="number" name="amount_paid" id="wb_amount" step="1"
                                class="w-full px-3 py-2 border border-gray-300 rounded focus:border-blue-500 focus:outline-none text-sm bg-gray-100" readonly>
                        </div>
                        <div class="mb-4">
                            <label class="block mb-2 font-bold text-gray-800">Transaction Description</label>
                            <textarea name="transaction_descr" id="wb_desc" rows="2"
                                class="w-full px-3 py-2 border border-gray-300 rounded focus:border-blue-500 focus:outline-none text-sm bg-gray-50" readonly>WheelBarrow Tickets</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-section hidden bg-white p-6 my-5 rounded-lg shadow-md" id="form_abattoir">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div class="mb-4">
                                ...
                                <select name="category" id="ab_category"
                                    class="w-full px-3 py-2 border border-gray-300 rounded focus:border-blue-500 focus:outline-none text-sm" onchange="calculateAmount()">
                                    <option value="">Select category</option>
                                    <option value="Cows Killed" data-amount="1800">Cows Killed</option>
                                    <option value="Cows Takeaway" data-amount="1000">Cows Takeaway</option>
                                    <option data-amount="400" value="Goats Killed">Goats Killed</option>
                                    <option data-amount="100" value="Goats Takeaway">Goats Takeaway</option>
                                    <option data-amount="250" value="Pots of Pomo">Pots of Pomo</option>
                                </select>
                            </div>
                            <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <label class="block mb-2 font-bold text-gray-800">Amount <span
                                    class="text-red-600">*</span></label>
                            <input type="number" name="amount_paid" id="ab_amount" step="1"
                                class="w-full px-3 py-2 border border-gray-300 rounded focus:border-blue-500 focus:outline-none text-sm bg-gray-100">
                        </div>
                        <div class="mb-4">
                            <label class="block mb-2 font-bold text-gray-800">Transaction Description</label>
                            <textarea name="transaction_descr" id="ab_desc" rows="2"
                                class="w-full px-3 py-2 border border-gray-300 rounded focus:border-blue-500 focus:outline-none text-sm bg-gray-50" readonly>Abattoir</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-section hidden bg-white p-6 my-5 rounded-lg shadow-md" id="form_overnight_parking">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="type" id="op_type" onchange="showOvernightCategory()"
                                ...
                                <option value="Vehicle" data-amount="1">Vehicle</option>
                                <option value="Forklift Operator" data-amount="2">Forklift Operator</option>
                                <option value="Artisan" data-amount="3">Artisan</option>
                            </select>
                        </div>
                        <div class="mb-4 hidden" id="op_vehicle_div">
                            ...
                            <select name="category" id="op_vehicle_cat" onchange="calculateAmount()"
                                class="w-full px-3 py-2 border border-gray-300 rounded focus:border-blue-500 focus:outline-none text-sm">
                                <option value="">Select category</option>
                                <option value="Overnight Parking - 40 feet - N5000" data-amount="5000">Overnight Parking - 40 feet - N5000
                                </option>
                                <option value="Overnight Parking - OK Trucks - N2000" data-amount="2000">Overnight Parking - OK Trucks - N2000</option>
                                <option value="Overnight Parking - LT Buses - N1500" data-amount="1500">Overnight Parking - LT Buses - N1500
                                </option>
                                <option value="Overnight Parking - Sienna - N1000" data-amount="1000">Overnight Parking - Sienna - N1000
                                </option>
                                <option value="Overnight Parking - Cars - N1000" data-amount="1000">Overnight Parking - Cars - N1000
                                </option>
                            </select>
                        </div>
                        <div class="mb-4 hidden" id="op_artisan_div">
                            <label class="block mb-2 font-bold text-gray-800">Artisan <span
                                    class="text-red-600">*</span></label>
                            <select name="artisan_category" id="op_artisan_cat" onchange="calculateAmount()"
                                class="w-full px-3 py-2 border border-gray-300 rounded focus:border-blue-500 focus:outline-none text-sm">
                                <option value="">Select a category</option>
                                <option value="Welder/Welding Equipment" data-amount="500">Welder/Welding Equipment</option>
                                <option data-amount="500" value="Carpenter">Carpenter</option>
                                <option data-amount="500" value="Bricklayer">Bricklayer</option>
                                <option data-amount="500" value="Others">Others</option>
                            </select>
                    ...
                    <div class="form-section hidden bg-white p-6 my-5 rounded-lg shadow-md" id="form_scroll_board">
                        ...
                        <div class="mb-4">
                            <label class="block mb-2 font-bold text-gray-800">Expected Yearly Rent:</label>
                            <input type="text" id="sb_yearly" readonly
                                class="w-full px-3 py-2 border border-gray-300 rounded bg-gray-100 text-sm">
                        </div>
                        <div class="mb-4">
                            <label class="block mb-2 font-bold text-gray-800">Amount <span
                                    class="text-red-600">*</span></label>
                            <input type="number" name="amount_paid" id="sb_amount" step="1"
                                class="w-full px-3 py-2 border border-gray-300 rounded focus:border-blue-500 focus:outline-none text-sm">
                        </div>
                        <div class="mb-4">
                            <label class="block mb-2 font-bold text-gray-800">Transaction Description</label>
                            <textarea name="transaction_descr" id="sb_desc" rows="2"
                                class="w-full px-3 py-2 border border-gray-300 rounded focus:border-blue-500 focus:outline-none text-sm bg-gray-50" readonly>Scroll Board</textarea>
                        </div>
                    </div>
    ...
    <script>
        ...
        function calculateAmount() {
            ...
            if (incomeLine === 'hawkers') {
                const hawkersTickets = parseInt(document.getElementById('hw_tickets').value) || 0;
                document.getElementById('hw_amount').value = (200 * hawkersTickets).toFixed(2);
            }
            ...
            if (incomeLine === 'loading') {
                ...
                const amount = parseFloat(selectedOption?.getAttribute('data-amount')) ||
                    0; // If data-amount is not found, amount will be 0
            ...
            if (incomeLine === 'overnight_parking') {
                ...
                const selectType = document.getElementById('op_type');
                const selectTypeOption = parseFloat(selectType.options[selectType.selectedIndex]?.getAttribute('data-amount'));

                const nights = parseInt(document.getElementById('op_nights').value) || 1;

                if (selectTypeOption === 1) {
                    const overnightCategory = document.getElementById('op_vehicle_cat');
                    const overnightAmount = parseFloat(overnightCategory.options[overnightCategory.selectedIndex]?.getAttribute('data-amount'));
                    document.getElementById('overnight_amount').value = (overnightAmount * nights).toFixed(2);
                } else if (selectTypeOption === 2) {
                    document.getElementById('overnight_amount').value = (500 * nights).toFixed(2);
                } else {
                    const artisanCategory = document.getElementById('op_artisan_cat');
                    const artisanAmount = parseFloat(artisanCategory.options[artisanCategory.selectedIndex]?.getAttribute('data-amount'));
                    document.getElementById('overnight_amount').value = (artisanAmount * nights).toFixed(2);
                }

            }

            if (incomeLine === 'wheelbarrow') {
                const wheelbarrowTickets = parseInt(document.getElementById('wb_tickets').value) || 0;
                document.getElementById('wb_amount').value = (300 * wheelbarrowTickets).toFixed(2);
            }

            if (incomeLine === 'abattoir') {
                // 1. Get the select element
                const category = document.getElementById('ab_category');
                // 2. Safely retrieve the numerical value from the 'data-amount' attribute
                ...
                // 3. Get the number of days, defaulting to 1
                const quantity = parseInt(document.getElementById('ab_quantity').value) || 1;

                // 4. Calculate and set the amount
                document.getElementById('ab_amount').value = (amount * quantity).toFixed(2);
            }
        ...
        function showOvernightCategory() {
            ...
            const artisanDiv = document.getElementById('op_artisan_div');

            //let value = document.getElementById('overnight_amount').value;


            if (type === 'Vehicle') {
                vehicleDiv.classList.remove('hidden');
                document.getElementById('overnight_amount').value = "";
            } else if (type === 'Artisan') {
                vehicleDiv.classList.add('hidden');
                artisanDiv.classList.remove('hidden');
                document.getElementById('overnight_amount').value = "";
            } else {
                vehicleDiv.classList.add('hidden');
                artisanDiv.classList.add('hidden');
                document.getElementById('overnight_amount').value = "";
            }
        }
        ...
        function loadScrollBoardInfo() {
            ...
            document.getElementById('sb_monthly').value = '₦' + parseFloat(option.getAttribute('data-monthly') || 0)
                .toLocaleString();
            document.getElementById('sb_yearly').value = '₦' + parseFloat(option.getAttribute('data-yearly') || 0)
                .toLocaleString();
        }
